  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio :label="3" v-model="radioValue">
        周期从
        <el-input-number v-model="cycle01" :min="fullYear" :max="cycle02" />
        -
    ...
    <el-form-item>
      <el-radio :label="4" v-model="radioValue">
        ...
        年开始，每
        <el-input-number v-model="average02" :min="1" />
        年执行一次
      </el-radio>
    </el-form-item>
...
export default {
  ...
  computed: {
    ...
    cycleTotal: function() {
      ...
      this.cycle02 = this.checkNum(this.cycle02, this.fullYear, this.fullYear + 100)
